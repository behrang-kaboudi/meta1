    ...
    bd.creatPromotion = function() {
        ...
        <div style="z-index: 150; margin-top: 10px" class="   w-100 d-flex flex-column my-1 " style="width: 100%;height:1000px">
            <div id="${parentId}promotionb" class="picPromotion py-12 d-flex d-none justify-content-center">
                <img onclick="bd.doPromotion('n')" src="/components/bk-chessboard/pices/bn.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('b')" src="/components/bk-chessboard/pices/bb.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('r')" src="/components/bk-chessboard/pices/br.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('q')" src="/components/bk-chessboard/pices/bq.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
            </div>
            <div id="${parentId}promotionw" class="picPromotion justify-content-center py-12 d-flex d-none" style="width: 100%">
                <img onclick="bd.doPromotion('n')" src="/components/bk-chessboard/pices/wn.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('b')" src="/components/bk-chessboard/pices/wb.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('r')" src="/components/bk-chessboard/pices/wr.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
                <img onclick="bd.doPromotion('q')" src="/components/bk-chessboard/pices/wq.svg" class="bg-light mx-1 rounded-2" style="width: 14%; border: 1px solid; " />
            </div>
        </div>
        `;
