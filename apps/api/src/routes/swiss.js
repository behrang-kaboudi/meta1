...
const swissTournament = require("../models/swiss/swiss");
const swissPlayers = require("../models/swiss/swissPlayers");
// const livePairing = require('../models/swiss/livePairing').funcs;
const rtGame = require("./game");
const Game = require("../models/game/game");
const pairing = require("../models/swiss/pairing");
const pairPlayers = require("../models/swiss/pairPlayers");
...
router.io.finished = async function (data, ack, userData) {
  let tours = await swissTournament
...
router.io.myGames = async function (data, ack, userData) {
  ...
  let player = await swissPlayers.findOne({
...
router.io.reset = async function (data, ack, userData) {
  ...
  await swissTournament.updateOne(
    { _id: data.id },
    { round: 0, status: "open" }
  );
};
