...
bkGraphicalBoard.Arrow = class {
    ...
    creat() {
        ...
        let html = `<svg class="bk-arrow-mask"> <marker id="triangle-red"
...
bkGraphicalBoard.BkBoard = class {
    constructor(parentIdOrObj, settingObj) {
        ...
        this.size.window = window.innerWidth;
        this.allSquers = [];
        this.mainSqs = [];
    ...
    resize() {
        // let percent = 1;
        // let dif = window.innerWidth - this.size.window;
        // if (dif == 0) return;
        // if (dif < 0) {
        //     percent = window.innerWidth / this.size.window
        // } else {
        //     percent = this.size.window / window.innerWidth;
        // }
        // // percent = 1 - percent;
        // let width = this.parent.style.width.slice(0, this.parent.style.width.length - 2);
        // width = parseInt(width * percent);
        // // let percent = window.innerWidth > this.size.window ?
        // //     this.size.window = window.innerWidth;
        // // console.log('this.parent', width, percent);
    ...
    setSize() {
        let boardSize = this.parent.style.width.slice(0, this.parent.style.width.length - 2);

        if (!this.parent.style.width || this.parent.style.width.includes('%')) {
            this.parent.style.width = '100%';
            boardSize = this.parent.offsetWidth;
