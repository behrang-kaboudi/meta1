	...
	_create() {
		...
		this.html =
			...
			`
				...
				<tr>
					<td class=' d-flex justify-content-center align-items-center p-0'>
						${this.rank}
					</td>
				</tr>
            <div  style='${elCss}' class='d-flex justify-content-between dir-ltr'>
                ...
                <div class='d-flex  me-5 ' style= "width: 50%">
                    ${roundPoints}
                </div>
...
class StandingList extends SbkC {
    ...
    There Is No Data
		...
		this.html =
            ...
            <div class='mb-3 sbkc-fs-8'  style = 'border:solid 1px rgb(204, 204, 204); border-radius: 6px;height:700px'>
