...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-PIMDTAKO.js";
import {
  capitalize_default,
  memoTheme_default
} from "./chunk-DRSPUYWB.js";
import {
  useDefaultProps
} from "./chunk-MTILKO2Q.js";
import {
  composeClasses,
  exactProp,
...
import {
  require_react_dom
} from "./chunk-G3SEN7II.js";
import {
  require_react
} from "./chunk-I3ZCNIXP.js";
import {
  __toESM
...
var Tooltip = React6.forwardRef(function Tooltip2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTooltip"
  });
  ...
  const children = React6.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime4.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  const [childNode, setChildNode] = React6.useState();
  const [arrowRef, setArrowRef] = React6.useState(null);
  const ignoreNonTouchEvents = React6.useRef(false);
  ...
  const prevUserSelect = React6.useRef();
  ...
  React6.useEffect(() => stopTouchInteraction, [stopTouchInteraction]);
  ...
  const [, setChildIsFocusVisible] = React6.useState(false);
  ...
  return (0, import_jsx_runtime4.jsxs)(React6.Fragment, {
    children: [React6.cloneElement(children, childrenProps), (0, import_jsx_runtime4.jsx)(PopperSlot, {
...
true ? Tooltip.propTypes = {
  ...
  slotProps: import_prop_types6.default.shape({
    arrow: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    popper: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    tooltip: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
...
//# sourceMappingURL=chunk-ADJBI63C.js.map
