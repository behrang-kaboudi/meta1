...
const joiSchema = {
  mailUser: Joi.string().min(3).messages(ut.joi.getJoiEnglishErrs('Username / Email')),
  ...
  userName: Joi.string().custom(ut.joi.english).messages(ut.joi.getJoiEnglishErrs('Username')),
};
